# Yolo-v3 from beginning

## Model structure
[model structure code](./resources/model_code.md)
![model structure](./resources/yolov3_model_structure.jpeg)
<details>
...
- **grid与image的对应**
    ![对应示例](./resources/grid_vs_image.png)
- **anchor box**
...
- **prediction box (feature map)**
  ...
  - xywh在算loss时进行mapping, 映射到一个值域小的范围, 保持训练稳定
    ![mapping](./resources/bias_mapping.png)
...
[dataset code](./resources/dataset_code.md)
...
[loss function code](./resources/loss_code.md)
![loss formula](./resources/loss_formula.png)
- **noobj loss**
